...
import com.vtheatre.config.drm.ResponseFormat;
import com.vtheatre.exception.drm.PallyConTokenException;
import com.vtheatre.util.StringEncrypter;
...
@JsonPropertyOrder({ "drm_type", "site_id", "user_id", "cid", "policy", "response_format", "timestamp", "hash" })
public class PallyConDrmTokenClient implements PallyConDrmToken {
    ...
    public PallyConDrmTokenClient policy(PallyConDrmTokenPolicy policyRequest)
            throws PallyConTokenException, Exception {
