...
import com.vtheatre.config.drm.security.playready.*;

/**
 * @related security_policy
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonPropertyOrder({ "security_level", "digital_video_protection_level", "analog_video_protection_level",
...
public class SecurityPolicyPlayready {
    ...
    @Deprecated
    public SecurityPolicyPlayready compressedDigitalAudioProtection(
            CompressedDigitalAudioProtection compressedDigitalAudioProtection) {
        this.compressedDigitalAudioProtection = compressedDigitalAudioProtection.getValue();
        return this;
    }

    @Deprecated
    public SecurityPolicyPlayready uncompressedDigitalAudioProtection(
            UnCompressedDigitalAudioProtection uncompressedDigitalAudioProtection) {
