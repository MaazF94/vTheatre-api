...
public class ExternalKeyPolicy {
    ...
    /**
     * constructs a mpegCenc list adding a mpegCenc to existing mpegCenc list
     * step-by-step.
     */
    ...
    /**
     * constructs a hlsAes list adding a hlsAes to existing hlsAes list
     * step-by-step.
     */
    ...
    public void check() throws PallyConTokenException {
        ...
        if (0 == this.mpegCencList.size() && 0 == this.hlsAesList.size() && null == this.ncg) {
